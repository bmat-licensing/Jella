...
public class Album extends BaseObject {
     ...
     * */
    public Album(final EllaConnection ellaConnection, final String id, final String collection) {
        super(ellaConnection, id, collection);
        this.method = "/releases/" + this.id + ".json";
        this.metadataLinks = new String[]{"spotify_release_url", "amazon_release_url", "itms_release_url", "rhapsody_release_url", "emusic_release_url",
                "limewire_release_url", "trackitdown_release_url", "juno_release_url", "rateyourmusic_release_url", "metacritic_release_url",
                "pitchfork_release_url", "bbc_co_uk_release_url", "rollingstone_release_url", "cloudspeakers_url"};
    ...
    public ArrayList<Track> getTracks() throws ServiceException, IOException {
        ...
        for (Object json : results) {
            JSONObject jsonAlbum = (JSONObject) json;
            JSONObject jsonEntity = (JSONObject) jsonAlbum.get("entity");
